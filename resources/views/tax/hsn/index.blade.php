...
<tbody>
                   @foreach($hsns as $Hsna)
                        <tr>
                            <td class="col-md-1 text-center">{{ $Hsna->hsn}}</td>
                            <td class="col-md-1 text-center">{{ $Hsna->item}}</td>
                            <td class="col-md-1 text-center">{{ $Hsna->hsn_d }}</td>
                            <td class="col-md-1 text-center">{{ $Hsna->gst_rate}}</td>
                            <td class="col-md-1 text-center">{{ $Hsna->gst_d}}</td>
                            <td class="col-md-1 text-center">{{ $Hsna->cess_rate}}</td>
                            <td class="col-md-1 text-center">{{ $Hsna->cess_d}}</td>
