          ...
          <tbody>
            ...
            <tr id="item-row-{{ $item_row }}" class="item-row">
              ...
              <td class="text-right" style="vertical-align: middle;">
                <span id="item-tax-info-0" class="item-tax-info" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="Please Select All OptionscFirst" data-html="true" style="float:left"><i style="font-size:1.5vw;" class="fa">&#xf129;</i></span>
...
$(document).on('click','.extra-info-modal',function(event){
        event.preventDefault();
