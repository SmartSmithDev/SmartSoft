...
class Sale extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['company_branch_id','company_id','company_account_id','customer_id','ecommerce_vendor_id', 'supplier_state_id', 'supply_state_id', 'order_id', 'invoice_number', 'invoice_date', 'invoice_type', 'order_date', 'sales_type', 'total_taxable_value', 'total_discount', 'cgst', 'sgst', 'igst', 'ugst', 'cess', 'total_tax_amount', 'shipping_cost','payment_status', 'round_off', 'total_amount', 'reverse_charge', 'notes', 'created_at', 'updated_at', 'deleted_at'];
    ...
    {
        return $this->hasMany('App\Models\Sale\SalesItem', 'sales_id');
    }
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
